...
membersRouter.post('/tracker/members/add', (req, res) => {
...
membersRouter.get('/tracker/technologies/get', async (req, res) => {
    const teams = await Teams.find();
    res.status(200).json(teams);
});

membersRouter.post('/tracker/technologies/add', async (req, res) => {
    Teams.create({ name: req.body.technology_name }, function (err, data) {
        if (err) {
            console.log('error ignore');
            return res.status(400).json({ error: err });
...
membersRouter.delete('/tracker/technologies/remove/:name', async (req, res) => {
...
membersRouter.patch('/tracker/members/update/:id', async (req, res) => {
...
membersRouter.get('/tracker/members/display', async (req, res) => {
    let query = {};
    let sort = {}
...
membersRouter.delete('/tracker/members/delete/:id', async (req, res) => {
